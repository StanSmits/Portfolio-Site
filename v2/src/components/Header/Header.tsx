      ...
      <div className="w-full flex flex-row justify-start p-4 pb-12 z-10 relative transition-all duration-500">
        <div className="container p-5 w-lg">
          ...
          <p className="text-dark dark:text-light text-xl md:text-2xl lg:text-3xl text-clip max-w-xl font-thin transition-all duration-500">
            Stan Smits is a 19-year-old software engineer currently studying at
            Hogeschool Leiden. With a passion for problem-solving and
            ...
            attention to detail, and collaborative approach make him a valuable
            asset to any team. Through his work at Hogeschool Leiden and beyond,
            Stan is committed to creating technology that not only meets the
