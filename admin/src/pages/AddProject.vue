<template>
  <div class="container mx-auto p-4">
    <h1 class="inline-block text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">Create new project entry</h1>
...
export default {
  ...
  methods: {
    submitForm() {
      ...
      axios
        .post("http://139.162.162.34:8080/projects", {
          name: this.form.name,
